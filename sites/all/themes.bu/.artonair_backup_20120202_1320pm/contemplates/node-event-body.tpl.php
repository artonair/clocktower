  ...
  <?php } ?>
   ...
   <div class="content-section">
	...
	<div class="listen">
	  ...
	  <?php } ?>
	  <?php if($node->field_reference_exhibition[0]['view']) {  ?>
	    <div class="curators-list">
	      <?php if($node->field_reference_exhibition[0]['view']) print 'As part of the exhibition '; ?>
	      <span class="single-curator"><?php print $node->field_reference_exhibition[0]['view']; ?></span>
	    </div>
	  <?php } ?>	  
	  <?php if($node->field_event_date[0]['value']) { ?>
	    <div class="exhibited_date">
	      <?php if($node->field_event_date[0]['value']) print 'On view on '; ?>
