...
/*
	...
	/* if playlist is over 
        ...
        <?php if($session_no > 1) print "document.location.href='http://www.artonair.org/flashplayer/$SHOW_NAME/$SHOW_NAME-player.php?session_no=" . ($session_no - 1) . "';";  ?>    }

*/ 

    /*if player is not playing, then it's okay to close the window. */
