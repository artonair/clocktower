<html> 
<body> 
<h1>ALL OF THESE SHOWS AREN'T QUITE COMPLETED! OH NOOOOOOOOOOOOOOOOOOOOOO</h1>
...
<a href="_incomplete_shows_nodate.php">nodate</a>|<a href="_incomplete_shows_noseries.php">noseries</a>|<a href="_incomplete_shows_nohost.php">nohost</a>|
----------------------------
...
// if it doesn't have a date, or isn't connected to a series or a host 
if(
  (!($node->field_aired_date[0]['value'])) 
  || (!($node->field_series[0]['nid']))
  || (!($node->field_host[0]['nid']))
  ) { 
...
print "$textmatch shows need to be fixed! (out of a total of $rowcount shows)<br/>\n";
